...
Compaction* LevelCompactionBuilder::PickCompaction() {
  ...
  //   printf("[CompactionPicker] Picked input file number: %lu, size: %lu\n",
  //          f->fd.GetNumber(), f->fd.GetFileSize());
  // }
  // printf("[CompactionPicker] start_level: %d, output_level: %d\n",
  //        start_level_, output_level_);
  // printf("[CompactionPicker] compaction_reason: %d\n",
  //        static_cast<int>(compaction_reason_));
