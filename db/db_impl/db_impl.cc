...
DBImpl::DBImpl(const DBOptions& options, const std::string& dbname,
  ...
  if (pirMod::learned_index_enabled) {
    pirMod::file_data = new pirMod::FileLearnedIndexData(dbname_, pirMod::li_type);
    pirMod::env = options.env;
  }
}
