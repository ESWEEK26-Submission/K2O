...
struct PerfContextBase {
  ...
  // Time spent on creating index block iterator
  uint64_t index_block_iter_nanos;
  ...
  // Time spent on seeking a key in index blocks
  uint64_t index_block_seek_nanos;
  // Time spent on seeking a key in data blocks
  uint64_t data_block_seek_nanos;
